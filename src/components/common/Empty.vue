      ...
      <div class="el-empty__image" style="width: 200px;">
        <svg viewBox="0 0 79 86" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <defs>
            ...
            <rect id="path-3-5" x="0" y="0" width="17" height="36"></rect>
          </defs>
            ...
            <g id="B-type" transform="translate(-1268.000000, -535.000000)">
              <g id="Group-2" transform="translate(1268.000000, 535.000000)">
                ...
                <g id="Group-Copy"
                  ...
                  <rect id="Rectangle-Copy-12" fill="url(#linearGradient-1-5)"
                ...
                <rect id="Rectangle-Copy-15" fill="url(#linearGradient-2-5)" x="13" y="45" width="40"
                      height="36"></rect>
                <g id="Rectangle-Copy-17" transform="translate(53.000000, 45.000000)">
                  <mask id="mask-4-5" fill="white">
                    <use xlink:href="#path-3-5"></use>
                  </mask>
                  <use id="Mask" fill="#E0E3E9"
                       transform="translate(8.500000, 18.000000) scale(-1, 1) translate(-8.500000, -18.000000) "
                       xlink:href="#path-3-5"></use>
                  <polygon id="Rectangle-Copy" fill="#D5D7DE" mask="url(#mask-4-5)"
